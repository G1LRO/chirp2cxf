...
with open('chirp.csv', mode='r') as csv_file:
    ...
    for row in csv_reader:
        ...
        print ('<Channel Name=',Name,'chanIndex=',chanIndex,'>')
        print ('  <BandWidth>',Bandwidth,'</BandWidth>')
        print ('  <TxFreq>',TxFreq,'</TxFreq>')
        print ('  <RxFreq>',RxFreq,'</RxFreq>')
        print ('  <TxPowerLevel>',TxPowerLevel,'</TxPowerLevel>')
        print ('  <AnaTxCTCFlag>',AnaTxCTCFlag,'</AnaTxCTCFlag>')
        print ('  <AnaRxCTCFlag>',AnaRxCTCFlag,'</AnaRxCTCFlag>')
        print ('  <AnaTxCTCIndex>',AnaTxCTCIndex,'</AnaTxCTCIndex>')
        print ('  <AnaRxCTCIndex>',AnaRxCTCIndex,'</AnaRxCTCIndex>')
